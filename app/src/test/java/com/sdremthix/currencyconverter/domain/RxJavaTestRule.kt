package com.sdremthix.currencyconverter.domain
...
/**
 * Test rule found for running all test on the Schedulers.trampoline() although there's no guarantee that  the return tasks will be executed on the main looper.
 */
